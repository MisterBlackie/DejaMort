...
public class Hammer : MonoBehaviour, IWeapon
{
    ...
    public static string UniqueCode { get; private set; } = "HAMMER";
    ...
    public string itemName { get; private set; } = "Marteau";

    public string description { get; private set; } = "Sert a cogner des clous. Et des zombies.";
    ...
    public void Awake()
    {
        ...
        displayImage = Resources.Load<Sprite>("Sprite/hammer");

        HandPosition = new Vector3(0.00056f, 0.00095f, -0.00017f);
        ObjectRotation = new Vector3(-73.32401f, -181.219f, 74.61f);
    }
